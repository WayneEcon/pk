...
#### **轨道一的核心环节**
```
02_net_analysis → 03_metrics → 04_policy_analysis → 研究结论
                              ↓
                         政策效应量化
```
...
### **完整分析流程**
```python
from src.04_policy_analysis import run_full_policy_analysis
...
### **自定义分析**
```python
from src.04_policy_analysis.analysis import (
...
### **可视化生成**
```python
from src.04_policy_analysis.plotting import create_policy_impact_dashboard
